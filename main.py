...
from keyboards.inline_keyboards import get_main_menu_keyboard, get_authors_keyboard, get_chat_keyboard
...
📅 <b>На сайте с:</b> {datetime.fromisoformat(user_data.get('created_at', datetime.now().isoformat())).strftime('%d.%m.%Y')}
"""
