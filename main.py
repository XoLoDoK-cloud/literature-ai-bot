...
async def handle_message(message: Message):
    ...
    try:
        ...
        if not user_data.get("selected_author"):
            # КРАСИВОЕ СООБЩЕНИЕ С НОВОЙ КЛАВИАТУРОЙ
            await message.answer(
                f"""
<code>━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</code>
...
""",
                parse_mode=ParseMode.HTML,
                reply_markup=get_authors_keyboard()  # ← НОВАЯ КРАСИВАЯ КЛАВИАТУРА
            )
            return
        
        # ... остальной код обработки сообщения с выбранным автором
